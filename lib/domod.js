...
window.$l = arg => {
  if(typeof arg === 'string') {
    if(arg[0] === '<'){
      return new __WEBPACK_IMPORTED_MODULE_0__dom_node_collection_js__["a" /* default */]([createElement(arg)]);
    } else {
      const DOMNodes = [];
      ...
      return new __WEBPACK_IMPORTED_MODULE_0__dom_node_collection_js__["a" /* default */](DOMNodes);
    }
...
const nodeFromDom = string => {
  ...
  return new __WEBPACK_IMPORTED_MODULE_0__dom_node_collection_js__["a" /* default */](nodesArray);
};
